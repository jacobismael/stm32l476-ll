...
ARR_DESC_DEFINE(BIGGEST_INPUT_TYPE, support_output_fut, MAX_INPUT_ELEMENTS,
                CURLY(0));

ARR_DESC_DEFINE(BIGGEST_INPUT_TYPE, support_output_ref, MAX_INPUT_ELEMENTS,
                CURLY(0));
...
ARR_DESC_DEFINE(float32_t, support_f_32, 32,
                CURLY(0.24865986, -0.13364227, -0.27233250, -7.33488200,
...
ARR_DESC_DEFINE(ARR_DESC_t *, support_f_all, 4,
                CURLY(&support_zeros, &support_f_2, &support_f_15,
                      &support_f_32));
