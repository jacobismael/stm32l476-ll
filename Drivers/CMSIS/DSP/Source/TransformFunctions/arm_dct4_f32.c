...
/**
  ...
  length of the DCT4;
                   \c normalize is normalizing factor used and is equal to
  <code>sqrt(2/N)</code>;
                   \c pTwiddle points to the twiddle factor table;
                   \c pCosFactor points to the cosFactor table;
                   \c pRfft points to the real FFT instance;
                   \c pCfft points to the complex FFT instance;
                   The CFFT and RFFT structures also needs to be initialized,
  refer to arm_cfft_radix4_f32() and arm_rfft_f32() respectively for details
  regarding static initialization.
